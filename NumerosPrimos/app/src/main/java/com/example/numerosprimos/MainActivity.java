...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPalindromo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                evaluarPalindromo(jetN.getText().toString());                               //Se llama a la función para evaluar el "número maravilloso"
            }
        });
    ...
    public void evaluarPrimo(int a)
    {
        ...
        if (contador == 2)
        {
            jtv1.setText("El número "+ x +" es primo");
        }
        else
        {
            jtv1.setText("El número "+ x +" no es primo");
        }
    ...
    public void evaluarFibo(int a)
    {
        ...
        while(evaluacionTerminada == false)
        {
            ...
            if(suma == a)
            {
                ...
                jtv1.setText("Los numeros Fibonacci son  "+ res + "\nEl " + x +" es un número Fibonacci");
    ...
    public void evaluarPalindromo(String a)
    {
        ...
        {
            jtv1.setText("El número "+ a + " es palíndromo");
        }
        else
        {
            jtv1.setText("El número "+ a + " no es palíndromo");
        }
    }
